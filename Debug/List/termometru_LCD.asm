...
_0x0:
	.DB  0x25,0x64,0x25,0x63,0x43,0x0,0x25,0x64
	.DB  0x25,0x63,0x46,0x20,0x0,0x25,0x64,0x25
	.DB  0x63,0x4B,0x20,0x0,0x54,0x65,0x6D,0x70
	.DB  0x65,0x72,0x61,0x74,0x75,0x72,0x61,0x3A
	.DB  0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 00DD sprintf(TemperatureC,"%d%cC", (int)celsius, degree_sysmbol);
	LDI  R30,LOW(_TemperatureC)
	LDI  R31,HIGH(_TemperatureC)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
...
; 0000 00E0 sprintf(TemperatureF,"%d%cF ", (int)fahren, degree_sysmbol);
	LDI  R30,LOW(_TemperatureF)
	LDI  R31,HIGH(_TemperatureF)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,6
	ST   -Y,R31
...
; 0000 00E2 sprintf(TemperatureK,"%d%cK ", (int)kelvin, degree_sysmbol);
	LDI  R30,LOW(_TemperatureK)
	LDI  R31,HIGH(_TemperatureK)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,13
	ST   -Y,R31
...
; 0000 00FB lcd_puts(TemperatureK);
	LDI  R26,LOW(_TemperatureK)
	LDI  R27,HIGH(_TemperatureK)
	RJMP _0x13
...
; 0000 0104 lcd_puts(TemperatureF);
	LDI  R26,LOW(_TemperatureF)
	LDI  R27,HIGH(_TemperatureF)
	RJMP _0x13
...
; 0000 010D lcd_puts(TemperatureC);
	LDI  R26,LOW(_TemperatureC)
	LDI  R27,HIGH(_TemperatureC)
_0x13:
	RCALL _lcd_puts
